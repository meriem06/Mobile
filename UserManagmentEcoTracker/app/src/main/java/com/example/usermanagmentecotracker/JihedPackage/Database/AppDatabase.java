...
import com.example.usermanagmentecotracker.JihedPackage.Directory.TemperatureDao;
...
@Database(entities = {User.class, Defis.class, Consommation.class , HistoriqueTable.class , Luminosite.class , Activity.class , TemperatureEntry.class}, version = 2)
