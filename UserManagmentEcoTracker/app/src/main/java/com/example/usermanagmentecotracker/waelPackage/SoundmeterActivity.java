package com.example.usermanagmentecotracker.waelPackage;
...
public class SoundmeterActivity extends AppCompatActivity {
    ...
    private void initUI() {
        speedometer = findViewById(R.id.sspeedometer);
    ...
    private void saveMaxSoundToDatabase() {
        ...
        HistoriqueTable entry = new HistoriqueTable(currentMaxSound, timestamp , LoginActivity.idUserToConsommations);
